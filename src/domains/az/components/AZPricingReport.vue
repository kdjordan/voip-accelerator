<template>
  <div v-if="report" class="space-y-10">
    ...
    <div class="border border-fbBorder rounded-lg">
      <h2
        class="py-4 text-sizeLg text-center text-fbWhite px-6 border-b border-fbBorder"
      >
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b border-fbBorder">
              <th
                class="py-3 text-left px-4 max-w-[250px] w-[250px]"
              >
                Dial Code(s)
              </th>
              <th class="py-3 text-left text-gray-400 px-4">Destination</th>
    ...
    <div class="rounded-lg overflow-hidden border border-fbBorder">
      <div
        class="py-4 px-6 flex justify-between items-center border-b border-fbBorder"
      >
        <div class="w-1/4"></div>
        <h2
        class="py-4 text-sizeLg text-center text-fbWhite px-6"
      >
          Unmatched Codes
        </h2>
...
import type { AzPricingReport } from "@/domains/az/types/az-types";
