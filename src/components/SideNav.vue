<template>
  ...
  >
    <div class="p-4 flex flex-col pt-10 relative">
      <h1 class="tracking-widest text-center text-sizeBase">Telecom Toolkit</h1>
    </div>
    ...
    <div class="profile-section p-4">
      <div class="flex flex-col items-center mb-4">
        ...
        >
          <span class="flex items-center justify-center h-12 w-12 bg-gray-400 rounded-full text-xl font-bold text-white">MG</span>
        </div>
        <h4 class="text-base font-medium">Michael Gough</h4>
        <p class="text-sm ">name@company.com</p>
      </div>
      ...
      <button class="bg-secondary-foreground w-full my-2 text-foreground">
        Upgrade to Pro
      </button>
      <button class="btn btn-destructive w-full">
        Logout
      </button>
    </div>
  </nav>
...
import { DocumentCurrencyDollarIcon, BarsArrowDownIcon, PercentBadgeIcon } from '@heroicons/vue/24/outline'
