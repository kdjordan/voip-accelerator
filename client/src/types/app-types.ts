...
export const DBSchemas = {
  ...
  [DBName.LERG]: 'enhanced_lerg: npa, country_code, country_name, state_province_code, state_province_name, region, category, source, confidence_score, *category, *country_code, *state_province_code',
