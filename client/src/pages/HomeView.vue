        ...
        <div class="space-y-8">
          ...
          <div ref="ctaButtons" class="flex flex-wrap gap-4 pt-4 opacity-0">
            ...
            <button
              ...
              class="bg-white/10 text-white font-medium px-8 py-3 rounded-3xl hover:bg-white/20 transition-colors text-center border border-white/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
