              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                  <div
                    ...
                    "
                  ></div>
                  <span v-if="!dbStatus.connected" class="text-red-400 text-sm">
                    {{ dbStatus.error }}
                    <span v-if="dbStatus.details" class="block text-xs mt-1 text-red-300">{{
                      dbStatus.details
                    }}</span>
                  </span>
        ...
        <div v-if="showStorageSection" class="border-t border-gray-700/50 p-6 flex flex-col gap-6">
          ...
          <div class="bg-gray-900/30 rounded-lg p-6">
              ...
              <div>
                <div class="flex justify-between items-center">
                  ...
                  <div
                    class="text-lg"
                    :class="{
                      'text-red-400': memoryPercentage > 80,
                      'text-yellow-400': memoryPercentage > 50,
                      'text-green-400': memoryPercentage <= 50,
                    }"
                  >
                    {{ memoryUsage.toFixed(1) }} MB ({{ memoryPercentage.toFixed(0) }}% of heap
                    limit)
                  </div>
                </div>
              ...
              <div>
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span
                      class="text-sm"
                      :class="autoFallback ? 'text-accent' : 'text-gray-400'"
                      id="autoFallbackStatus"
                    >
            ...
            <div class="space-y-4">
                ...
                <button
                  ...
                  :class="
                    currentStrategy === 'memory'
                      ...
                      : 'bg-violet-900/60 hover:bg-violet-800'
                  "
                >
                  Use Memory Storage
                </button>
              ...
              <div
                class="text-xs text-gray-400 grid grid-cols-2 gap-4 border-t border-gray-700/50 pt-4"
              >
                <div>
            ...
            <div v-if="showPerformanceSection" class="p-4">
              <div v-if="metrics.length > 0" class="overflow-x-auto">
                <table class="w-full text-sm">
                  ...
                  <tbody>
                    <tr
                      v-for="(group, i) in groupedMetrics"
                      :key="i"
                    ...
                    >
                      ...
                      <td
                        class="py-3"
                        :class="{
                          'text-green-400': group.speedup > 1,
                          'text-red-400': group.speedup < 1,
                        }"
                      >
...
async function runPerformanceTests() {
  ...
  try {
    ...
    const azMetrics = await runPerformanceTest(DBName.AZ, generateTestData, [100, 1000, 5000]);
