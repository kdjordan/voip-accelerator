...
import { US_JOURNEY_MESSAGES, JOURNEY_STATE } from '@/constants/messages';
...
function __VLS_template() {
    ...
    if (__VLS_ctx.usStore.reportsGenerated) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("bg-gray-800 px-6") }, });
        ...
        for (const [type] of __VLS_getVForSourceType((__VLS_ctx.reportTypes))) {
            __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (...[$event]) => {
                        if (!((__VLS_ctx.usStore.reportsGenerated)))
                            return;
                        __VLS_ctx.usStore.setActiveReportType(type);
                    } }, key: ((type)), ...{ class: ("mr-8 py-4 px-1 relative") }, ...{ class: (([
                        'hover:text-white transition-colors',
                        {
                            'text-white': __VLS_ctx.usStore.activeReportType === type,
                            'text-gray-400': __VLS_ctx.usStore.activeReportType !== type,
                        },
                    ])) }, });
            if (type !== __VLS_ctx.ReportTypes.FILES) {
            ...
            if (__VLS_ctx.usStore.activeReportType === type) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (__VLS_ctx.handleReset) }, ...{ class: ("btn-destructive ml-auto mb-2") }, });
    }
