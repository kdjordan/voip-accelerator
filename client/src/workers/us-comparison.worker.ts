...
function generateReports(input: USReportsInput): {
  ...
  const file1Stats = {
    ...
    averageIndetermRate: calculateAverage(file1Data, 'indetermRate'),
    medianInterRate: calculateMedian(file1Data, 'interRate'),
    medianIntraRate: calculateMedian(file1Data, 'intraRate'),
    medianIndetermRate: calculateMedian(file1Data, 'indetermRate'),
    ...
    minIndetermRate: calculateMin(file1Data, 'indetermRate'),
    maxIndetermRate: calculateMax(file1Data, 'indetermRate'),
    indetermRateCount: file1Data.filter((d) => d.indetermRate > 0).length,
  };

  const file2Stats = {
    averageInterRate: calculateAverage(file2Data, 'interRate'),
    averageIntraRate: calculateAverage(file2Data, 'intraRate'),
    averageIndetermRate: calculateAverage(file2Data, 'indetermRate'),
    medianInterRate: calculateMedian(file2Data, 'interRate'),
    medianIntraRate: calculateMedian(file2Data, 'intraRate'),
    medianIndetermRate: calculateMedian(file2Data, 'indetermRate'),
    ...
    minIndetermRate: calculateMin(file2Data, 'indetermRate'),
    maxIndetermRate: calculateMax(file2Data, 'indetermRate'),
    indetermRateCount: file2Data.filter((d) => d.indetermRate > 0).length,
  };
  ...
  const pricingReport: USPricingReport = {
    ...
    comparison: {
      ...
      indetermRateDifference: calculatePercentageDifference(
        file1Stats.averageIndetermRate,
        file2Stats.averageIndetermRate
      ),
      totalHigher: 0,
      totalLower: 0,
      totalEqual: 0,
  ...
  const codeReport: USCodeReport = {
    file1: {
      ...
      rateStats: {
        ...
        indeterminate: {
          average: file1Stats.averageIndetermRate,
          median: file1Stats.medianIndetermRate,
          min: file1Stats.minIndetermRate,
          max: file1Stats.maxIndetermRate,
          count: file1Stats.indetermRateCount,
        },
      },
    },
    file2: {
      ...
      rateStats: {
        ...
        indeterminate: {
          average: file2Stats.averageIndetermRate,
          median: file2Stats.medianIndetermRate,
          min: file2Stats.minIndetermRate,
          max: file2Stats.maxIndetermRate,
          count: file2Stats.indetermRateCount,
        },
      },
    },
    matchedCodes: 0,
