...
export class StoreStrategy<T> extends BaseStorageStrategy<T> {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to initialize store: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async storeData(tableName: string, data: T[]): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to store data in store: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getData(
    ...
    try {
      ...
      throw new Error(
        `Failed to get data from store: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async removeData(tableName: string): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to remove data from store: ${
  ...
  async clearAllData(): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to clear all data from store: ${
          error instanceof Error ? error.message : String(error)
        }`
      );
    }
  ...
  async getCount(tableName: string): Promise<number> {
    try {
      ...
      if (true) {
        console.log(`[StoreStrategy] Count for ${tableName}: ${data.length}`);
      }
  ...
  async listTables(): Promise<{ tableName: string; recordCount: number }[]> {
    ...
    try {
      ...
      throw new Error(
        `Failed to list tables from store: ${
          error instanceof Error ? error.message : String(error)
        }`
      );
    }
